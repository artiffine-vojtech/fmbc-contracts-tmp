...
describe('TokenEmissionsController', function () {
  ...
  async function deployContractFixtureWithUserStakedFor60Days() {
    ...
    await incentivesController.connect(user).deposit(K1_TOKENS, 0)
    return {
      stakingToken,
      nftContract,
      incentivesController,
  ...
  async function deployContractFixtureWithUserStakedFor90Days() {
    ...
    await incentivesController.connect(user).deposit(K1_TOKENS, 1)
    return {
      stakingToken,
      nftContract,
      incentivesController,
  ...
  async function deployContractFixtureWithUserStakedFor120Days() {
    ...
    await incentivesController.connect(user).deposit(K1_TOKENS, 2)
    return {
      stakingToken,
      nftContract,
      incentivesController,
  ...
  describe('Deposit', () => {
    it('Should revert on amount zero', async () => {
      ...
      let action = incentivesController.connect(user).deposit(0, 0)
