...
export interface FMBCMemberNFTVerifierInterface extends utils.Interface {
  functions: {
...
export interface FMBCMemberNFTVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FMBCMemberNFTVerifierInterface;
