...
export interface AirdropNFTHoldersInterface extends utils.Interface {
  functions: {
...
export interface AirdropNFTHolders extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirdropNFTHoldersInterface;
