...
export interface MEMEVestingInterface extends utils.Interface {
  functions: {
...
export interface MEMEVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MEMEVestingInterface;
  ...
  functions: {
    ...
    memeToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    memeToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    memeToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
