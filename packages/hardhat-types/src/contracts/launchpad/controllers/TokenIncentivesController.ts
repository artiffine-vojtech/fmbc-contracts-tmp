...
export interface TokenIncentivesControllerInterface extends utils.Interface {
  functions: {
    ...
    "setWithdrawingAdmin(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setWithdrawingAdmin",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface TokenIncentivesController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenIncentivesControllerInterface;
