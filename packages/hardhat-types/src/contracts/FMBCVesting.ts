...
export interface FMBCVestingInterface extends utils.Interface {
  functions: {
...
export interface FMBCVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FMBCVestingInterface;
  ...
  functions: {
    ...
    getVestingPositions(
      _account: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[IVesting.VestingPositionStructOutput[]]>;
