...
export interface FomoBullClubNFT_old_polygonInterface extends utils.Interface {
  functions: {
...
export interface FomoBullClubNFT_old_polygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FomoBullClubNFT_old_polygonInterface;
