...
export interface FOMOPublicSaleWithCustomTokenInterface
...
export interface FOMOPublicSaleWithCustomToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FOMOPublicSaleWithCustomTokenInterface;
